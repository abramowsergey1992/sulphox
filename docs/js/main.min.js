if(document.querySelector(".history")&&document.querySelectorAll(".history").forEach(t=>{let r=t.querySelectorAll(".swiper-slide"),o=t.querySelector(".history__pagination"),e=t.querySelector(".history__progress-line");const s=new Swiper(t.querySelector(".history-slider"),{slidesPerView:1,slideToClickedSlide:!0,centeredSlides:!0,on:{slideChange:function(){e.style.width=100/(r.length-1)*this.activeIndex+"%";for(let e=1;e<=r.length;e++)e<this.activeIndex+1?(t.querySelector("._p-"+e).classList.add("_past"),t.querySelector("._p-"+e).classList.remove("_now")):e==this.activeIndex+1?(t.querySelector("._p-"+e).classList.remove("_past"),t.querySelector("._p-"+e).classList.add("_now")):t.querySelector("._p-"+e).classList.remove("_past","_now")}}});for(let e=1;e<=r.length;e++)pagi=document.createElement("div"),pagi.classList.add("history__pagi"),pagi.classList.add("_p-"+e),1==e&&pagi.classList.add("_now"),pagi.innerHTML="<span>"+r[e-1].querySelector(".history-it__title").innerText+"</span>",o.append(pagi),pagi.addEventListener("click",function(){s.slideTo(e-1)})}),document.querySelector(".ours-project")&&document.querySelectorAll(".ours-project").forEach(e=>{const r=new Swiper(e.querySelector(".ours-project__slider"),{speed:400,observer:!0,spaceBetween:10,threshold:40,observeParents:!0});let o=e.querySelectorAll(".ours-project__filter");o.forEach(t=>{t.addEventListener("click",function(){o.forEach(e=>{e.classList.remove("_active")}),t.classList.add("_active"),"all"==t.dataset.filter?document.querySelectorAll(".ours-project .ours-project__slide").forEach(e=>{e.classList.remove("d-none")}):(document.querySelectorAll(".ours-project .ours-project__slide").forEach(e=>{t.dataset.filter==e.dataset.filter?(e.classList.remove("d-none"),console.log(e.querySelector(".swiper").swiper),e.querySelector(".swiper").swiper.update()):e.classList.add("d-none")}),r.update())})})}),document.querySelector(".catalog")&&document.querySelectorAll(".catalog").forEach(e=>{let t=e.querySelector(".catalog__more"),r=t.dataset.pagelenght,o=e.querySelectorAll(".catalog-1,.catalog-2");moreRender(r,o,!0,t),t.addEventListener("click",function(){moreRender(r,o,!1,t)})}),document.querySelector(".presentations")&&document.querySelectorAll(".presentations").forEach(e=>{const t=new Swiper(e.querySelector(".presentations__slider"),{speed:400,allowTouchMove:!1});let r=e.querySelectorAll(".presentations__filter");r.forEach(e=>{e.addEventListener("click",function(){r.forEach(e=>{e.classList.remove("_active")}),e.classList.add("_active"),t.slideTo(e.dataset.slide)})})}),document.querySelector(".cleaning-method")&&document.querySelectorAll(".cleaning-method").forEach(e=>{const t=new Swiper(e.querySelector(".cleaning-method__swiper"),{speed:400,allowTouchMove:!1});let r=e.querySelectorAll(".cleaning-method__btn");r.forEach(e=>{e.addEventListener("click",function(){r.forEach(e=>{e.classList.remove("_active")}),e.classList.add("_active"),t.slideTo(e.dataset.slide)})})}),document.querySelector(".product-gallery")&&document.querySelectorAll(".product-gallery").forEach(t=>{if(1<t.querySelectorAll(".product-gallery-top  .swiper-slide").length){let e=t.closest(".detail");e.classList.add("_with-gallery"),t.innerHTML+='<div class="product-gallery-thumb-wrap"><div class="product-gallery-thumb-wrap__prev"></div><div class="product-gallery-thumb swiper">'+t.querySelector(".product-gallery-top ").innerHTML+'</div><div class="product-gallery-thumb-wrap__next"></div></div>';var r=t.querySelector(".product-gallery-top"),o=t.querySelector(".product-gallery-thumb"),s=t.querySelector(".product-gallery-thumb-wrap__prev"),t=t.querySelector(".product-gallery-thumb-wrap__next"),o=new Swiper(o,{spaceBetween:12,setWrapperSize:!0,watchSlidesProgress:!0,slidesPerView:3});new Swiper(r,{navigation:{nextEl:t,prevEl:s},spaceBetween:12,setWrapperSize:!0,slidesPerView:1,thumbs:{swiper:o}})}}),document.querySelector(".solutions-slider")&&document.querySelectorAll(".solutions-slider").forEach(e=>{var t=e.querySelector(".solutions-slider__slider"),r=e.querySelector(".solutions-slider__nav-prev"),e=e.querySelector(".solutions-slider__nav-next");new Swiper(t,{navigation:{nextEl:e,prevEl:r},spaceBetween:21,setWrapperSize:!0,slidesPerView:"auto"})}),$(function(){$("#contact-form").length&&$("#contact-form").validate({errorPlacement:function(e,t){},submitHandler:function(e){$(e).find(".btn").attr("disabled","disabled"),$.ajax({url:$(e).attr("action"),data:$(e).serialize(),method:"POST",headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")},context:document.body,success:function(){alert("Форма отправленна успешно"),$(e).find(".btn").removeAttr("disabled")},error:function(){alert("Ошибка"),$(e).find(".btn").removeAttr("disabled")}})}})}),document.querySelector(".video-page ")&&document.querySelectorAll(".video-page ").forEach(e=>{let t=e.querySelector(".video-page__more"),r=t.dataset.pagelenght,o=e.querySelectorAll(".video-it");moreRender(r,o,!0,t),t.addEventListener("click",function(){moreRender(r,o,!1,t)})}),$(function(){$(".mp").magnificPopup({type:"image"})}),document.querySelectorAll(".news-page").forEach(e=>{let t=e.querySelectorAll(".news-item,.article-item"),r=e.querySelector(".news-page__row").dataset.pagelength,o=e.querySelector(".news-page__more"),s=e.querySelectorAll(".news-page__filter");filterRender(r,t,"all",!0,o),o.addEventListener("click",function(){filterRender(r,t,e.querySelector(".news-page__filter._active").dataset.filter,!1,o)}),s.forEach(e=>{e.addEventListener("click",function(){e.classList.contains("_active")||(s.forEach(e=>{e.classList.remove("_active")}),e.classList.add("_active"),filterRender(r,t,e.dataset.filter,!0,o))})})}),$(function(){}),document.querySelector(".quiz-slider")&&(document.querySelectorAll(".quiz-slider").forEach(t=>{let r=t.querySelectorAll(".swiper-slide"),o=t.querySelector(".quiz-slider__paginator"),e=t.querySelector(".quiz-slider__progress-line");for(let e=1;e<=r.length;e++)pagi=document.createElement("div"),pagi.classList.add("quiz-slider__pagi"),pagi.classList.add("_p-"+e),1==e&&pagi.classList.add("_now"),pagi.innerText=e<=10?"0"+e:e,o.append(pagi);new Swiper(t,{allowTouchMove:!1,on:{slideChange:function(){e.style.width=100/(r.length-1)*this.activeIndex+"%";for(let e=1;e<=r.length;e++)e<this.activeIndex+1?(t.querySelector("._p-"+e).classList.add("_past"),t.querySelector("._p-"+e).classList.remove("_now")):e==this.activeIndex+1?(t.querySelector("._p-"+e).classList.remove("_past"),t.querySelector("._p-"+e).classList.add("_now")):t.querySelector("._p-"+e).classList.remove("_past","_now")}}})}),$(document).on("click",".quiz-radio__input",function(){this.addEventListener("change",function(){this.closest(".swiper-slide").querySelector(".quiz-slider__next ").removeAttribute("disabled")})}),$(document).on("click",".quiz-slider__next",function(){$(this).closest(".swiper");let r=$(this).closest(".swiper-slide").next(".swiper-slide"),o=$(this).closest(".swiper")[0].swiper;if(!$(this)[0].hasAttribute("disabled")){let e=$(this).closest(".swiper-slide");"step"==$(this).attr("status")?$.ajax({url:$(this).attr("url"),data:{step:$(this).attr("step"),answer:e.find(".quiz-radio__input").val()},method:$(this).attr("method"),headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")},context:document.body,success:function(e){console.log(e);let t=`<h2 class="quiz-slider__title">${e.title}</h2>`;e.variants.forEach(function(e){t+=`<label class="quiz-radio">
